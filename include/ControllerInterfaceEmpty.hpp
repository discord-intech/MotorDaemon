...
#ifndef MOTORDAEMON_HERMES_CONTROLLERINTERFACEEMPTY_HPP
#define MOTORDAEMON_HERMES_CONTROLLERINTERFACEEMPTY_HPP

#include "Cinematic.hpp"
#include "ControllerInterface.hpp"

class ControllerInterfaceEmpty : public ControllerInterface
{
public:

    ControllerInterfaceEmpty() = default;
    ...
    virtual void printConsts(void) {};

    virtual void printTranslationError(void) {};

    virtual void setNeonSpeed(unsigned char s) {};
};
